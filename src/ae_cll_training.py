...
optimizer = torch.optim.Adam(model.parameters(), lr=0.0001, weight_decay=0.015)
epochs = 50
hist_train = []
hist_val = []
...
torch.save(model.state_dict(), '../models/cll_trained_ae.pth')
...
plt.legend()
plt.savefig('../imgs/loss_ae_cll.png')
plt.close()