...
class DrugRank(torch.nn.Module):
    def __init__(self, cll_size, mol_size):
        ...
        self.conv1_mol = tg.nn.GraphConv(mol_size, 2000)
        self.conv2_mol = tg.nn.GraphConv(2000, 1000)
        self.linear1_mol = tg.nn.Linear(1000, 1000)
        self.linear2_mol = tg.nn.Linear(1000, 1000)
        self.linear3_mol = tg.nn.Linear(1000, 500)
        self.linear4_mol = tg.nn.Linear(500, 300)
        self.linear5_mol = tg.nn.Linear(300, 300)

        self.linear1_cll = tg.nn.Linear(cll_size, 3000)
        self.linear2_cll = tg.nn.Linear(3000, 3000)
        self.linear3_cll = tg.nn.Linear(3000, 2000)
        ...
        self.bilinear = torch.nn.Bilinear(300, 300, 1)
