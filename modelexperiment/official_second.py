...
class DrugRank(torch.nn.Module):
    def __init__(self, cll_size, mol_size):
        ...
        self.conv2_mol = tg.nn.GraphConv(1000, 700)
        self.linear1_mol = tg.nn.Linear(700, 500)
        self.linear2_mol = tg.nn.Linear(500, 400)
        self.linear3_mol = tg.nn.Linear(400, 300)
        self.linear4_mol = tg.nn.Linear(300, 100)

        self.linear1_cll = tg.nn.Linear(cll_size, 2000)
        self.linear2_cll = tg.nn.Linear(2000, 2000)
        self.linear3_cll = tg.nn.Linear(2000, 1000)
        self.linear4_cll = tg.nn.Linear(1000, 1000)
        self.linear5_cll = tg.nn.Linear(1000, 500)
        self.linear6_cll = tg.nn.Linear(500, 300)
        self.linear7_cll = tg.nn.Linear(300, 100)
